---
name: "source-command-localization-update-for-new-feature"
description: "Workflow command scaffold for localization-update-for-new-feature in mi-notes."
---

# source-command-localization-update-for-new-feature

Use this skill when the user asks to run the migrated source command `localization-update-for-new-feature`.
